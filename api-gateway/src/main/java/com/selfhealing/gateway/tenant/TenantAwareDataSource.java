...
import com.selfhealing.gateway.config.MultiTenancyProperties;
 ...
 *
 * <p>If no tenant is in context the configured default tenant is used (when
 * {@code fallbackToDefault} is on); otherwise the context is left blank, which
 * the fail-closed policies treat as "no rows".
 */
public class TenantAwareDataSource extends DelegatingDataSource {
    ...
    /** Resets the tenant GUC before the connection goes back to the pool. */
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            if ("close".equals(method.getName())) {
                try {
                    ...
                    // best-effort reset; still close the connection below
                }
            }
            try {
