...
class InterServiceRouteDiscoveryTest {
    ...
    void discoversDemoRoutesFromBaselineConfig() {
        ...
        when(transformationRuleRepository.findDistinctActiveRoutes()).thenReturn(List.of());
        when(responseTransformationRuleRepository.findDistinctActiveRoutes()).thenReturn(List.of());
    ...
    @Test
    void discoversCallerToProviderFromRequestContracts() {
        when(transformationRuleRepository.findDistinctActiveRoutes()).thenReturn(List.of());
        when(responseTransformationRuleRepository.findDistinctActiveRoutes()).thenReturn(List.of());
        when(serviceContractRepository.findByIsActiveTrue()).thenReturn(List.of(
    ...
    @Test
    void discoversResponseErrorRouteFromResponseContracts() {
        when(transformationRuleRepository.findDistinctActiveRoutes()).thenReturn(List.of());
        when(responseTransformationRuleRepository.findDistinctActiveRoutes()).thenReturn(List.of());
        when(serviceContractRepository.findByIsActiveTrue()).thenReturn(List.of(
