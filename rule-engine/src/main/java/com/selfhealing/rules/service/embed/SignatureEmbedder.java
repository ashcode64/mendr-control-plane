package com.selfhealing.rules.service.embed;
...
/**
 * Deterministic 768-d hashing embedder — must match
 * ai-analysis SignatureEmbedder and conversation-engine embeddings.hash_embed.
 */
