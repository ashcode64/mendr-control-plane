package com.selfhealing.notification.tenant;
 ...
 * listener runs, and clears it afterwards, so any RLS-scoped DB access inside
 * the listener uses the originating tenant.
 */
