...
/**
 * Builds ROUTING_OVERRIDE base URLs from Mendr registry and DNS probe data.
 * Host comes from the attempted URL; port comes from the registered base URL.
 */
public final class RoutingUrlResolver {
    ...
    public static String mergeHostFromAttemptedPortFromRegistry(String attemptedUrl, String registeredBaseUrl) {
        ...
        // Prefer localhost/127.0.0.1 from registry — service-name DNS often fails on dev machines
        String host;
