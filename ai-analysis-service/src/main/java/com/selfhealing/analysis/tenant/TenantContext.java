...
/**
 * Holds the resolved tenant for the current thread (request or Kafka listener).
 * Read by {@code TenantAwareDataSource} when a JDBC connection is borrowed so
 * the matching {@code app.current_tenant} is set for Row-Level Security.
 */
